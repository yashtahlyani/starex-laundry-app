...
export default function AccountPage() {
  ...
  const input = { width: "100%", padding: "12px 14px", border: "1.5px solid #E4E4E7", borderRadius: 10, fontFamily: "Kodchasan, sans-serif", fontSize: "0.9375rem", color: "#161616", background: "#FAFAFA", outline: "none", boxSizing: "border-box" as const };
    ...
    <div style={{ background: "#FFFFFF", minHeight: "100vh", paddingTop: 96 }}>
      <div style={{ maxWidth: 700, margin: "0 auto", padding: "0 24px 96px" }}>
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, ease }}
          ...
          <div>
            <a href="/dashboard" style={{ display: "inline-flex", alignItems: "center", gap: 6, color: "#8C8C8C", fontFamily: "Kodchasan, sans-serif", fontSize: "0.85rem", textDecoration: "none", marginBottom: 8 }}>
              <ArrowLeft size={14} /> Back to dashboard
            </a>
            <h1 style={{ fontFamily: "Poppins, sans-serif", fontWeight: 700, fontSize: "1.8rem", color: "#161616", letterSpacing: "-0.02em" }}>Account settings</h1>
          </div>
          <button onClick={handleSignOut} style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "9px 18px", background: "none", border: "1.5px solid #E4E4E7", borderRadius: 120, cursor: "pointer", fontFamily: "Poppins, sans-serif", fontWeight: 600, fontSize: "0.82rem", color: "#8C8C8C" }}>
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.08, duration: 0.4, ease }}
          ...
          <form onSubmit={handleSaveProfile} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            <div>
              <label style={{ display: "block", fontFamily: "Poppins, sans-serif", fontWeight: 600, fontSize: "0.78rem", color: "#161616", marginBottom: 6 }}>Full name</label>
              <input style={input} value={profile.name} onChange={e => setProfile(p => ({ ...p, name: e.target.value }))} placeholder="Your name" />
            </div>
            <div>
              <label style={{ display: "block", fontFamily: "Poppins, sans-serif", fontWeight: 600, fontSize: "0.78rem", color: "#161616", marginBottom: 6 }}>Email address</label>
              <input style={{ ...input, background: "#F4F4F5", color: "#A1A1AA" }} value={user?.email ?? ""} readOnly />
            </div>
            <div>
              <label style={{ display: "block", fontFamily: "Poppins, sans-serif", fontWeight: 600, fontSize: "0.78rem", color: "#161616", marginBottom: 6 }}>Phone number</label>
              <input style={input} value={profile.phone} onChange={e => setProfile(p => ({ ...p, phone: e.target.value }))} placeholder="+1 (437) 607-7251" />
            </div>
            <button type="submit" disabled={saving}
              style={{ alignSelf: "flex-start", padding: "11px 24px", background: saving ? "#A1A1AA" : "#161616", color: "#fff", border: "none", borderRadius: 120, cursor: saving ? "not-allowed" : "pointer", fontFamily: "Poppins, sans-serif", fontWeight: 600, fontSize: "0.875rem", display: "inline-flex", alignItems: "center", gap: 8 }}>
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.14, duration: 0.4, ease }}
          ...
          <form onSubmit={handleChangePassword} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            <div>
              <label style={{ display: "block", fontFamily: "Poppins, sans-serif", fontWeight: 600, fontSize: "0.78rem", color: "#161616", marginBottom: 6 }}>New password</label>
            ...
            <div>
              <label style={{ display: "block", fontFamily: "Poppins, sans-serif", fontWeight: 600, fontSize: "0.78rem", color: "#161616", marginBottom: 6 }}>Confirm new password</label>
            ...
            <button type="submit" disabled={pwSaving}
              style={{ alignSelf: "flex-start", padding: "11px 24px", background: pwSaving ? "#A1A1AA" : "#161616", color: "#fff", border: "none", borderRadius: 120, cursor: pwSaving ? "not-allowed" : "pointer", fontFamily: "Poppins, sans-serif", fontWeight: 600, fontSize: "0.875rem" }}>
