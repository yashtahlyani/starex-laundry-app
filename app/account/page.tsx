...
export default function AccountPage() {
  ...
  const input = { width: "100%", padding: "12px 14px", border: "1.5px solid #E4E4E7", borderRadius: 10, fontFamily: "Kodchasan, sans-serif", fontSize: "0.9375rem", color: "#09090B", background: "#FAFAFA", outline: "none", boxSizing: "border-box" as const };
    ...
    <div style={{ background: "#F7F7F7", minHeight: "100vh", paddingTop: 96 }}>
      <div style={{ maxWidth: 700, margin: "0 auto", padding: "0 24px 96px" }}>
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, ease }}
          ...
          <div>
            <a href="/dashboard" style={{ display: "inline-flex", alignItems: "center", gap: 6, color: "#71717A", fontFamily: "Kodchasan, sans-serif", fontSize: "0.85rem", textDecoration: "none", marginBottom: 8 }}>
              <ArrowLeft size={14} /> Back to dashboard
            </a>
            <h1 style={{ fontFamily: "Poppins, sans-serif", fontWeight: 700, fontSize: "1.8rem", color: "#09090B", letterSpacing: "-0.02em" }}>Account settings</h1>
          </div>
          <button onClick={handleSignOut} style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "9px 18px", background: "none", border: "1.5px solid #E4E4E7", borderRadius: 120, cursor: "pointer", fontFamily: "Poppins, sans-serif", fontWeight: 600, fontSize: "0.82rem", color: "#71717A" }}>
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.08, duration: 0.4, ease }}
          ...
          <form onSubmit={handleSaveProfile} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            <div>
              <label style={{ display: "block", fontFamily: "Poppins, sans-serif", fontWeight: 600, fontSize: "0.78rem", color: "#09090B", marginBottom: 6 }}>Full name</label>
              <input style={input} value={profile.name} onChange={e => setProfile(p => ({ ...p, name: e.target.value }))} placeholder="Your name" />
            </div>
            <div>
              <label style={{ display: "block", fontFamily: "Poppins, sans-serif", fontWeight: 600, fontSize: "0.78rem", color: "#09090B", marginBottom: 6 }}>Email address</label>
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.14, duration: 0.4, ease }}
          ...
          <form onSubmit={handleChangePassword} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div>
              <label style={{ display: "block", fontFamily: "Poppins, sans-serif", fontWeight: 600, fontSize: "0.78rem", color: "#09090B", marginBottom: 6 }}>Confirm new password</label>
