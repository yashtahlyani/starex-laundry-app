  ...
  if (loading) return (
    <div style={{ minHeight: "100vh", background: "#FFFFFF", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ textAlign: "center" }}>
        <div style={{ width: 40, height: 40, borderRadius: "50%", border: "4px solid rgba(184,50,79,0.2)", borderTopColor: "#ED1D24", animation: "spin 0.8s linear infinite", margin: "0 auto 12px" }} />
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 24px 96px" }}>
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, ease }}
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            <div style={{ width: 48, height: 48, borderRadius: "50%", background: "linear-gradient(135deg,#F4524D,#ED1D24)", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "Poppins, sans-serif", fontWeight: 700, fontSize: "1.2rem", color: "#FFFFFF" }}>{initial}</div>
            <div>
        ...
        {activeOrder ? (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.45, ease }} style={{ marginBottom: 32 }}>
            ...
            <div style={{ background: "#fff", border: "1.5px solid #F4524D", borderRadius: 20, padding: "28px 30px", boxShadow: "0 4px 20px rgba(184,50,79,0.1)" }}>
        ...
        {recent.length > 0 && (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3, duration: 0.45, ease }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
              ...
              {orders.length > 5 && (
                <a href="/order" style={{ fontFamily: "Poppins, sans-serif", fontWeight: 600, fontSize: "0.82rem", color: "#B30F14", textDecoration: "none", display: "inline-flex", alignItems: "center", gap: 4 }}>
