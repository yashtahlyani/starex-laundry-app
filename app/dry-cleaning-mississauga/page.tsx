...
const SERVICE_JSON_LD = {
  ...
  areaServed: { "@type": "City", name: "Mississauga", containedInPlace: { "@type": "State", name: "Ontario" } },
  description: "Professional dry cleaning pickup and delivery for suits, sarees, gowns, coats and household items in Mississauga, Ontario.",
};

export default function DryCleaningMississaugaPage() {
  return (
    <>
      ...
      <LocalSEOLanding
        ...
        features={[
          "Free pickup and delivery to your door in Mississauga",
        ...
        faqs={[
          { q: "Do you dry clean suits, sarees and gowns in Mississauga?", a: "Yes — everyday and formal wear, outerwear, sarees, gowns, and household items like curtains and rugs are all covered. See the full price list on our Pricing page." },
          ...
          { q: "How fast is dry cleaning delivery in Mississauga?", a: "Most orders are ready for delivery within 24–48 hours of pickup." },
