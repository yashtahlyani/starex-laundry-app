...
export default function NotFound() {
  return (
    <div style={{ background: "#FFFFFF", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", position: "relative", overflow: "hidden" }}>
      {/* Ghost 404 */}
      <p aria-hidden="true" style={{
        position: "absolute", left: "50%", top: "50%", transform: "translate(-50%,-50%)",
        fontFamily: "Poppins, sans-serif", fontWeight: 700,
        fontSize: "clamp(8rem,25vw,20rem)", letterSpacing: "-0.04em", lineHeight: 0.85,
        color: "rgba(20,20,20,0.04)", userSelect: "none", pointerEvents: "none", whiteSpace: "nowrap",
      }}>404</p>
      ...
      >
        <span className="eyebrow" style={{ display: "block", marginBottom: 16, color: "#B30F14" }}>Page Not Found</span>
        ...
        <p style={{ color: "#6B6B6B", fontSize: "1.0625rem", lineHeight: 1.75, maxWidth: "42ch", margin: "0 auto 36px", fontFamily: "Kodchasan, sans-serif" }}>
