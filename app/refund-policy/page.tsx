...
const sections: LegalSection[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "ol", items: [
        "Contact us at info@royalarttreasure.com or 437-607-7251, including your Order number.",
  ...
  },
  {
    ...
    blocks: [
      { type: "ul", items: [
        { label: "Email:", text: "info@royalarttreasure.com" },
        { label: "Phone:", text: "437-607-7251" },
        { label: "Hours:", text: "7 days a week, 7:00 AM – 8:00 PM EST" },
        { label: "Mailing Address:", text: "Available on request — email info@royalarttreasure.com or call 437-607-7251, Brampton, ON" },
      ]},
