...
const services = [
  ...
  { id: "dry-clean", Icon: Sparkles, num: "03", title: "Dry Cleaning",          tagline: "Delicates deserve better.",         price: "From $4.99/item",  min: "$40 minimum order value",                                features: ["Suits, sarees, gowns and silks", "Leather jackets and winter coats", "Also covers household & bedding", "24–48hr turnaround", "Every price confirmed first", "Free pickup & delivery included"], featured: false },
