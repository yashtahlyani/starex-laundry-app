...
function AccordionItem({ q, a }: { q: string; a: string }) {
  ...
  return (
    <div style={{ borderBottom: "1px solid #E5E7EB", overflow: "hidden" }}>
      ...
      >
        <span style={{ fontFamily: "Poppins, sans-serif", fontWeight: 500, fontSize: "1rem", color: "#241619", letterSpacing: "-0.01em" }}>{q}</span>
        <motion.div animate={{ rotate: open ? 180 : 0 }} transition={{ duration: 0.25 }} style={{ flexShrink: 0 }}>
          <ChevronDown size={18} color="#6E5F5C" />
        </motion.div>
      </button>
      <AnimatePresence initial={false}>
        {open && (
          ...
          >
            <p style={{ paddingBottom: 20, color: "#6E5F5C", fontSize: "0.9375rem", lineHeight: 1.75, fontFamily: "Kodchasan, sans-serif" }}>{a}</p>
          </motion.div>
        )}
      </AnimatePresence>
    </div>
    ...
    <div style={{ background: "#FBF8F1" }}>
      ...
      <section style={{ padding: "80px 0 96px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 24px", display: "grid", gridTemplateColumns: "220px 1fr", gap: 48 }} className="faq-layout">
          ...
          <div style={search ? { gridColumn: "1 / -1" } : {}}>
            {search && (
              <p style={{ fontFamily: "Kodchasan, sans-serif", fontSize: "0.9rem", color: "#6E5F5C", marginBottom: 24 }}>
      ...
      <section style={{ padding: "64px 0 96px", textAlign: "center" }}>
        <div style={{ maxWidth: 480, margin: "0 auto", padding: "0 24px" }}>
          <h2 style={{ fontFamily: "Poppins, sans-serif", fontWeight: 600, fontSize: "clamp(1.5rem,3vw,2rem)", color: "#241619", marginBottom: 12, letterSpacing: "-0.022em" }}>
            Still need <em className="display-accent" style={{ display: "inline" }}>help?</em>
          </h2>
          <p style={{ color: "#6E5F5C", marginBottom: 28, fontFamily: "Kodchasan, sans-serif" }}>Our team responds within 1 business hour, 7 days a week.</p>
