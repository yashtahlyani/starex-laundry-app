            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(300px,1fr))", gap: 12 }}>
              {visible.map(o => (
                <motion.div key={o.id} layout initial={{ scale: 0.96, opacity: 0 }} animate={{ scale: 1, opacity: 1 }}
                  ...
                  <p style={{ fontFamily: "Kodchasan, sans-serif", fontSize: "0.8rem", color: "#71717A", marginBottom: 14 }}>{o.address}</p>
      ...
      <div style={{ background: "#fff", border: "1px solid #EAEAEA", borderRadius: 16, overflow: "hidden" }}>
        ...
        {orders.map((o, i) => (
          <button key={o.id} onClick={() => setSelected(o)} style={{
            ...
            <div>
              <p style={{ fontFamily: "Kodchasan, sans-serif", fontSize: "0.85rem", color: "#09090B", fontWeight: 500 }}>{o.customer_name ?? "—"}</p>
